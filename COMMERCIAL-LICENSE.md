...
If you want to use the File Upload self-hosted file manager in a product, service, production/staging environment, or other commercial activity, obtain a separate written commercial license from the copyright holder before use.
...
Nếu muốn dùng File Upload, một file manager tự host, trong sản phẩm, dịch vụ, môi trường production/staging hoặc hoạt động có mục đích thương mại, cần có commercial license bằng văn bản riêng từ chủ sở hữu bản quyền trước khi sử dụng.
