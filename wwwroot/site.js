...
const copy = {
  vi: {
    documentTitle: 'File Upload', languageLabel: 'Ngôn ngữ', title: 'Không gian file riêng', hint: 'Quản lý folder, upload nhiều file và tải xuống an toàn với upload token.',
  ...
  en: {
    documentTitle: 'File Upload', languageLabel: 'Language', title: 'Private file workspace', hint: 'Manage folders, upload multiple files, and download securely with an upload token.',
